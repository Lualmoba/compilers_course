...
public class sym {  /* terminals */
  ...
  static final int INCREMENT = 53;
  static final int DECREMENT = 54;
  // Added by CNF, 6/19/18
  static final int INT_BITSTR = 55;
  static final int AND = 56;
  static final int OR = 57;
};
